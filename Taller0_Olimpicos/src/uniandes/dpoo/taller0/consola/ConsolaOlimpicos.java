...
public class ConsolaOlimpicos
{
	...
	{
		System.out.println("\n" + "Pa�s perteneciente a Atleta" + "\n");
		
		String atlet = input("Por favor ingrese el nombre del atleta");
		String pai = calculadora.ejecutarPaisAtleta(atlet);
		System.out.println("El atleta " + atlet + " representa el pa�s de" + pai);
		
	}
	
	/**
	 * Le pide al usuario el nombre de un atleta y le da el pais que representa
	 */
